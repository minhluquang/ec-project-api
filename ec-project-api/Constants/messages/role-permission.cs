namespace ec_project_api.Constants.Messages
{
    public static class RoleMessages
    {
        ...
        public const string RoleRetrieved = "Lấy thông tin vai trò thành công.";
        ...
        public const string ListRolesNotFound = "Các role không tồn tại: {0}";
        public const string RolePermissionsAssigned = "Gán quyền cho vai trò thành công.";
    }
