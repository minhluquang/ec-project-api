...
{
    public static class ShipMessages
    {
        public const string ShipNotFound = "Không tìm thấy đơn vị vận chuyển.";
        public const string CreateFailed = "Không thể tạo đơn vị vận chuyển.";
