namespace ec_project_api.Constants.messages {
    public static class ColorMessages {
        public const string ColorNotFound = "Không tìm thấy màu sắc.";
        public const string ColorAlreadyExists = "Màu sắc đã tồn tại.";
        public const string ColorNameAlreadyExists = "Tên màu sắc đã tồn tại.";
        ...
        public const string SuccessfullyCreatedColor = "Tạo màu sắc thành công.";
